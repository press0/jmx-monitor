...
public class Facade {
	...
	* Wrapper methods 
	*/  
	public float getThreshold(){  return this.s.getThreshold(); }
	public void setThreshold( float f ){ 
		if ( f != this.s.getThreshold() ) {
			this.s.setThreshold( f ); }
		}

	public long getThresholdPollPeriod() {  return this.s.getThresholdPollPeriod(); }
	public void setThresholdPollPeriod( long f ) { 
		if ( f != this.s.getThresholdPollPeriod() ) {
			this.s.setThresholdPollPeriod( f ); }
		}

	public boolean isVerbose(){  return this.s.isVerbose(); }
	public void setVerbose( boolean b ){  
		if ( b != this.s.isVerbose() ) {
			this.s.setVerbose( b ); }
		}
	public boolean isEnabled(){  return this.s.isEnabled(); }
	...
	public boolean isLoadRunning() { return s.isLoadRunning() ; }
	...
	public String getStats() {  return this.s.getStats(); }
